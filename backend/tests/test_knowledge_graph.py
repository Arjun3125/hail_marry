...
import uuid
import pytest
from services.knowledge_graph import RELATION_TYPES
...
def test_kg_concept_model():
    from models.knowledge_graph import KGConcept
    concept = KGConcept(
...
def test_kg_relationship_model():
    from models.knowledge_graph import KGRelationship
    rel = KGRelationship(
        tenant_id=uuid.uuid4(),
...
def test_invalid_relation_type():
    from services.knowledge_graph import add_relationship

...
from src.domains.ai_engine.ai.hyde import hyde_transform
from src.domains.ai_engine.ai.cache import cache_response, get_cached_response
...
from src.domains.ai_engine.schemas.ai_runtime import AIQueryRequest, InternalAIQueryRequest
from src.domains.ai_engine.services.ai_gateway import run_text_query
from src.domains.ai_engine.services.knowledge_graph import get_concept_context
...
async def _prepare_ai_query(
    *,
    ...
    knowledge_context = await get_concept_context(db, tenant_id, query)

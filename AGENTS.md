...
This project is indexed by GitNexus as **proxy_notebooklm** (10736 symbols, 29267 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

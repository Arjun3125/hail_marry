...
This project is indexed by GitNexus as **proxy_notebooklm** (10944 symbols, 29519 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

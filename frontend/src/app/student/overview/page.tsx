...
export default function StudentOverview() {
    ...
    const taskFirstLinks = [
        { label: "Open mascot study assistant", href: "/student/assistant", priority: "high" as const },
    ...
    const recommendationHref = (item: PersonalizedRecommendation) => {
        if (item.target_tool === "mascot") return "/student/assistant";
        return "/student/ai-studio";
    };
        ...
        <div>
            ...
            {weakTopics.length > 0 && (
                <div className="bg-red-50 dark:bg-red-900/10 border border-error-subtle dark:border-red-900/30 rounded-[var(--radius)] p-4 mb-6 stagger-6">
                    ...
                    <a href="/student/assistant" className="inline-flex items-center gap-1 mt-3 text-xs font-medium text-[var(--error)] hover:underline">
                        <Zap className="w-3 h-3" /> Open personalized AI study plan
                    </a>
                </div>
            )}
            ...
            {recommendationItems.length > 0 && (
                <div className="bg-[var(--bg-card)] rounded-[var(--radius)] shadow-[var(--shadow-card)] p-5 border border-[var(--border)]/60 mb-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="text-sm font-semibold text-[var(--text-primary)]">Recommended for you</h2>
                    </div>
                    <div className="grid gap-3 md:grid-cols-3">
                        {recommendationItems.map((item) => (
                            ...
                            >
                                ...
                                <p className="text-sm font-semibold text-[var(--text-primary)] mb-2">{item.label}</p>
                                <p className="text-xs text-[var(--text-secondary)] leading-relaxed">{item.description}</p>
                                <div className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-[var(--primary)]">
                                    <Zap className="w-3 h-3" /> Open next step
                                </div>
                            </a>
                        ))}
                    </div>
                    ...
                    <div className="bg-[var(--bg-card)] rounded-[var(--radius)] p-5 shadow-[var(--shadow-card)] gradient-border">
                        ...
                        {stats.ai_insight ? (
                            <div className="p-3 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/10 dark:to-indigo-900/10 rounded-lg">
                                ...
                                <a href="/student/assistant" className="inline-flex items-center gap-1 mt-2 text-[10px] font-medium text-[var(--accent-purple)] hover:underline">
                                    Ask mascot for next step →
                                </a>
                            </div>
                        ) : (
